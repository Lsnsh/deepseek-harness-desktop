...
> [English](v0.1.0-beta.8-en.md) · [更新日志](../../CHANGELOG-zh.md) · [全部版本](../../README-zh.md#下载与安装)
...
- **macOS · Apple Silicon**：安装包（DMG）[DSH-DP_v0.1.0-beta.8_macOS_aarch64.dmg](https://github.com/Lsnsh/deepseek-harness-desktop/releases/download/v0.1.0-beta.8/DSH-DP_v0.1.0-beta.8_macOS_aarch64.dmg) ｜ 自动更新包 [DSH-DP_v0.1.0-beta.8_macOS_aarch64.app.tar.gz](https://github.com/Lsnsh/deepseek-harness-desktop/releases/download/v0.1.0-beta.8/DSH-DP_v0.1.0-beta.8_macOS_aarch64.app.tar.gz)

---
[GitHub Release](https://github.com/Lsnsh/deepseek-harness-desktop/releases/tag/v0.1.0-beta.8) · [代码仓库](https://github.com/Lsnsh/deepseek-harness-desktop) · [上一版本 0.1.0-beta.7](https://github.com/Lsnsh/deepseek-harness-desktop/compare/v0.1.0-beta.7...v0.1.0-beta.8)
